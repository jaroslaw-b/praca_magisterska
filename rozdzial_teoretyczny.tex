...
%TODO Tak teraz zauważyłem, że w obu metodach klasycznych nie ma nic o rozpoznawaniu - chociaż po 2 zdania dodać.
...
%TODO Ten SVM tak nie z gruszki, nie z pietruszki - zdanie wyjaśnienia
%TODO A jak tak czytam to cały akapit też niejasny - proszę to lepiej ująć.
%TODO Co jdst wejściem do klasyfikatora ?

Klasyfikator oparty na maszynie wektorów wspierających jest uczony w oparciu o obrazy uzyskane z detekcji za pomocą cech Haara. 
...
%TODO NIe bardzo to rozumiem... te kontury tylko do wizualizacji ?
...
%TODO A podali jakoś procent skuteczności ? Tylko JBC dla ilu klas
...
%TODO Tu jak dla mnie niejasne jest wyzaczanie tego ROI 32x32...
