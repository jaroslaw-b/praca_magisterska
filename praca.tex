...
\acknowledgements{Bardzo dziękuję żonie Beacie za ogromne pokłady wyrozumiałości, a także za dostarczanie dużej ilości herbaty w trakcie pisania.
Małej Zuzi dziękuję za nieskończoną liczbę sytuacji, które jeszcze bardziej motywowały do skończenia pracy.}
...
\include{rozdzial_teoretyczny}
\include{rozdzial_praktyczny}
%\include{rozdzial3}
%\include{rozdzial1}
%\include{rozdzial2}
%\include{tests}
